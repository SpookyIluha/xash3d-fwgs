...
DEFINES =  -DXASH_DEDICATED -DHAVE_STRICMP -DHAVE_STRCASECMP -DXASH_NO_NETWORK -D__vr4300__ -D__BIG_ENDIAN__ -DSTDINT_H='<stdint.h>' -DNDEBUG -DENGINE_DLL -DXASH_BUILD_COMMIT="64726f13-dirty" -DXASH_BUILD_BRANCH="master" -DXASH_LOW_MEMORY=1 -DXASH_ENABLE_MAIN=1 -DDBGHELP=1 -DPSAPI_VERSION=1 -DXASH_REF_SOFT_ENABLED=1 -DXASH_REF_GL_ENABLED=0 -D_CRT_SILENCE_NONCONFORMING_TGMATH_H=1 -DHAVE_TGMATH_H=0 -DHAVE_STRNICMP=1
